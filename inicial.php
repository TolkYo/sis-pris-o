...
<!-- Side-bar-->
<div class="wrapper">
    <link rel="stylesheet" href="../assets/css-matheus/roger.css">
    <?php //include '../inc/side-bar.php'; ?>

<div class="container-fluid"> 
   <div class="jumbotron jumbotron-fluid text-center">
    <h1>Sistema de Gestão Penitenciária</h1>
    <p>hello! my name is mr fear i wish i had a faster therapy ive come to mind control your needs tonight im gonna star all of your needs
        you know ill never disappear NOW GET ME OUT HERE JUST TRUST IN ME MY DEAR NO CURE IS COMING NEAR </p>

        <b>
            <button type="button" class="btn btn-primary btn-lg">Acessar Sistema</button> 
            <button type="button" class="btn btn-warning btn-lg">Alguma coisa muito foda</button>
        </b>

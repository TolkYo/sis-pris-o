...
<body>
    ...
    <nav class="navbar sis-o"> 
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand logo-text" href="#"> </a> SIS-O
            </div>
        </div>
    ...
    <div class="wrapper" id="pag-inicial">

        <div class="container-fluid">
            <div class="jumbotron jumbotron-fluid text-center jumbotron-sem-bg">
        ...
        <div class="container" id="especificacao">
            <div class="row">
